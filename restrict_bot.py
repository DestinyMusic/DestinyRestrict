...
<head>
    ...
    <style>
        ...
        /* --- ⚔️ ANIME MEGA THEMES (DIRECT TMDB LINKS) --- */
        [data-theme="anime-magic"] { --bg: #1a0b2e; --card: rgba(26, 11, 46, 0.6); --card-border: rgba(217, 70, 239, 0.4); --text: #fdf4ff; --subtext: #f0abfc; --accent: #e879f9; --glow: rgba(232, 121, 249, 0.6); --sidebar: rgba(26, 11, 46, 0.85); --anime-bg: url('https://image.tmdb.org/t/p/original/7hMTEEqQvLntA220d9p6a92E31P.jpg'); }
        [data-theme="one-piece"] { --bg: #0c1524; --card: rgba(12, 21, 36, 0.75); --card-border: rgba(251, 191, 36, 0.5); --text: #ffffff; --subtext: #fde68a; --accent: #fbbf24; --glow: rgba(251, 191, 36, 0.7); --sidebar: rgba(12, 21, 36, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/4qCqZeJeqAMhQzEsx1zX4PUDQf0.jpg'); }
        [data-theme="jjk"] { --bg: #09090b; --card: rgba(9, 9, 11, 0.75); --card-border: rgba(139, 92, 246, 0.5); --text: #f8fafc; --subtext: #c4b5fd; --accent: #8b5cf6; --glow: rgba(139, 92, 246, 0.7); --sidebar: rgba(9, 9, 11, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/y4DhwEN8uXo8qMngF5y6y3rJ22C.jpg'); }
        [data-theme="demon-slayer"] { --bg: #0f172a; --card: rgba(15, 23, 42, 0.75); --card-border: rgba(16, 185, 129, 0.5); --text: #f8fafc; --subtext: #a7f3d0; --accent: #10b981; --glow: rgba(16, 185, 129, 0.7); --sidebar: rgba(15, 23, 42, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/xUfRZu2mi8jH6SzQEJST6mLiAJU.jpg'); }
        [data-theme="aot"] { --bg: #1c1917; --card: rgba(28, 25, 23, 0.75); --card-border: rgba(132, 204, 22, 0.4); --text: #fafaf9; --subtext: #d9f99d; --accent: #84cc16; --glow: rgba(132, 204, 22, 0.6); --sidebar: rgba(28, 25, 23, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/yVuTrc33ApeEhiL9GlaT5ZNbL51.jpg'); }
        [data-theme="naruto"] { --bg: #1e1b4b; --card: rgba(30, 27, 75, 0.75); --card-border: rgba(249, 115, 22, 0.5); --text: #fffedd; --subtext: #fdba74; --accent: #f97316; --glow: rgba(249, 115, 22, 0.7); --sidebar: rgba(30, 27, 75, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/v5zgEeeEiRiy2HndIinqBvHEDtG.jpg'); }
        [data-theme="fma"] { --bg: #1a0f0f; --card: rgba(26, 15, 15, 0.8); --card-border: rgba(220, 38, 38, 0.5); --text: #fef2f2; --subtext: #fca5a5; --accent: #dc2626; --glow: rgba(220, 38, 38, 0.7); --sidebar: rgba(26, 15, 15, 0.95); --anime-bg: url('https://image.tmdb.org/t/p/original/51xONKDBwT3eGZ5lG8xI04p80n8.jpg'); }
        [data-theme="geass"] { --bg: #150a1e; --card: rgba(21, 10, 30, 0.75); --card-border: rgba(225, 29, 72, 0.5); --text: #fff1f2; --subtext: #fecdd3; --accent: #e11d48; --glow: rgba(225, 29, 72, 0.7); --sidebar: rgba(21, 10, 30, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/22oEGtWjZk3T216bE6dMBfPqTjQ.jpg'); }
        [data-theme="solo"] { --bg: #020617; --card: rgba(2, 6, 23, 0.75); --card-border: rgba(56, 189, 248, 0.5); --text: #f0f9ff; --subtext: #bae6fd; --accent: #38bdf8; --glow: rgba(56, 189, 248, 0.7); --sidebar: rgba(2, 6, 23, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/v1YEXZ1lA2LpYhGz2Q0iS3k1vK0.jpg'); }
        [data-theme="hxh"] { --bg: #064e3b; --card: rgba(6, 78, 59, 0.75); --card-border: rgba(34, 197, 94, 0.5); --text: #f0fdf4; --subtext: #86efac; --accent: #22c55e; --glow: rgba(34, 197, 94, 0.7); --sidebar: rgba(6, 78, 59, 0.9); --anime-bg: url('https://image.tmdb.org/t/p/original/xT9UD1wH1TMWkK0VnFpMh0t0W8u.jpg'); }
        [data-theme="death-note"] { --bg: #000000; --card: rgba(10, 10, 10, 0.85); --card-border: rgba(153, 27, 27, 0.6); --text: #e5e5e5; --subtext: #a3a3a3; --accent: #dc2626; --glow: rgba(220, 38, 38, 0.8); --sidebar: rgba(5, 5, 5, 0.95); --anime-bg: url('https://image.tmdb.org/t/p/original/t3fRhG1kOioRNYj08tDqS8A690R.jpg'); }
