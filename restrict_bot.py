...
async def _api_stream_handler(request):
    ...
    if is_audio:
        ...
        # 🟢 FIX: Added '-vsync 0' and '-muxdelay 0' to prevent PSA/VFR MKV framerate drops and guarantee perfect Subtitle/Audio sync
        cmd += ["-vsync", "0", "-muxdelay", "0", "-avoid_negative_ts", "make_zero", "-max_muxing_queue_size", "9999", "-movflags", "frag_keyframe+empty_moov+default_base_moof", "-f", "mp4", "pipe:1"]
